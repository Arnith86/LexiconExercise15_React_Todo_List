# Lexicon Exercise 15 - React Todo List

This repository contains my submitted solution for the React Todo List exercise.
The full exercise instructions can be found below.
